...
$(function() {
    /* Event happen when the GoTop button is pressed */
    $('#gotop').click(function(){
        $('html,body').animate({ scrollTop: 0 }, 'slow');   /* Return to the top */
        return false;
    });

    /* When the roll silde down over 400px, the GoTop button will appear */
